...
const register = async (req, res) => {
    ...
    const profilePicture = gender.toLowerCase()==="male" ? `https://avatar.iran.liara.run/public/boy?username=${username}`:`https://avatar.iran.liara.run/public/girl?username=${username}`
